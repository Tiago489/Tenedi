...
mapRegistry.publish({
  ...
  mappings: [
    ...
    // Shipper — N1 loop index 0 at detail level
    { jediPath: 'detail.n1_loop.0.n1.n1_element_02', systemPath: 'shipperInformation.name' },
    { jediPath: 'detail.n1_loop.0.n3.n3_element_01', systemPath: 'shipperInformation.addressLine1' },
    { jediPath: 'detail.n1_loop.0.n4.n4_element_01', systemPath: 'shipperInformation.city' },
    { jediPath: 'detail.n1_loop.0.n4.n4_element_02', systemPath: 'shipperInformation.state' },
    { jediPath: 'detail.n1_loop.0.n4.n4_element_03', systemPath: 'shipperInformation.zip' },
    { jediPath: 'detail.n1_loop.0.n4.n4_element_04', systemPath: 'shipperInformation.country' },
    { jediPath: 'detail.n1_loop.0.g61.g61_element_02', systemPath: 'shipperInformation.contactName' },
    { jediPath: 'detail.n1_loop.0.g61.g61_element_04', systemPath: 'shipperInformation.contactPhone' },

    // Consignee — N1 loop index 1 at detail level
    { jediPath: 'detail.n1_loop.1.n1.n1_element_02', systemPath: 'consigneeInformation.name' },
    { jediPath: 'detail.n1_loop.1.n3.n3_element_01', systemPath: 'consigneeInformation.addressLine1' },
    { jediPath: 'detail.n1_loop.1.n4.n4_element_01', systemPath: 'consigneeInformation.city' },
    { jediPath: 'detail.n1_loop.1.n4.n4_element_02', systemPath: 'consigneeInformation.state' },
    { jediPath: 'detail.n1_loop.1.n4.n4_element_03', systemPath: 'consigneeInformation.zip' },
    { jediPath: 'detail.n1_loop.1.n4.n4_element_04', systemPath: 'consigneeInformation.country' },
    { jediPath: 'detail.n1_loop.1.g61.g61_element_02', systemPath: 'consigneeInformation.contactName' },
    { jediPath: 'detail.n1_loop.1.g61.g61_element_04', systemPath: 'consigneeInformation.contactPhone' },

    // Packages — L5/AT8/L4 direct children of n1_loop.0
